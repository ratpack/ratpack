...
public class FlaggingResourceLeakDetectorFactory extends ResourceLeakDetectorFactory {

  public static void install() {
    ResourceLeakDetector.setLevel(ResourceLeakDetector.Level.PARANOID);
    ResourceLeakDetectorFactory.setResourceLeakDetectorFactory(new FlaggingResourceLeakDetectorFactory());
  }
