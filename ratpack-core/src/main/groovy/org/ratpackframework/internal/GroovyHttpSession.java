...
/**
 * Mercilessly stole this from the Gradle project, Thanks Graeme Rocher.
 */
public class GroovyHttpSession extends GroovyObjectSupport implements HttpSession {

  private HttpSession adaptee;
  private HttpServletRequest request;

  public GroovyHttpSession(HttpServletRequest request) {
