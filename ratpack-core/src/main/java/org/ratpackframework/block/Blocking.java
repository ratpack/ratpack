 ...
 * <p>
 * Instances of {@code Blocking} can be obtained via {@link org.ratpackframework.handling.Context#getBlocking()}.
 * <p>
 ...
 * to the {@link org.ratpackframework.handling.Context#error(Exception)} method of the current context.
 * Similarly, errors that occur during the result handler are forwarded.
 * </p>
 * <p>
 * To use a custom error handling strategy, use the {@link org.ratpackframework.block.Blocking.SuccessOrError#onError(org.ratpackframework.util.Action)} method
