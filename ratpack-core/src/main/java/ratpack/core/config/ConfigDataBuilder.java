...
import ratpack.core.config.internal.source.ArgsConfigSource;
...
public interface ConfigDataBuilder {
   ...
   * Alternative implementations, such as {@link ServerConfigBuilder#json(String)} may resolve the file location differently.
   *
   ...
   * <p>
   * The default implementation of {@link ConfigDataBuilder} will resolve the given path relative to the actual file system root.
   * Alternative implementations, such as {@link ServerConfigBuilder#props(String)} may resolve the file location differently.
   *
   ...
   * <p>
   * The default implementation of {@link ConfigDataBuilder} will resolve the given path relative to the actual file system root.
   * Alternative implementations, such as {@link ServerConfigBuilder#yaml(String)} may resolve the file location differently.
   *
