...
/**
 * An adapter from {@link ratpack.core.server.Service} to {@link Service}.
 * <p>
 * When using {@link ServiceDependenciesSpec#dependsOn(Predicate, Predicate)}, legacy services will be wrapped in this type.
 * <p>
 * This class is scheduled to be removed in 2.x, along with {@link ratpack.core.server.Service}.
 *
...
public interface LegacyServiceAdapter {
  ...
  ratpack.core.server.Service getAdapted();
