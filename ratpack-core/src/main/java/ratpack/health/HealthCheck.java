...
public interface HealthCheck {
  ...
  class Result {
     ...
     *
     * @param healthy if health check succeeded should be true
     * @param message message generated by health check
     * @param error exception thrown by health check execution
     */
