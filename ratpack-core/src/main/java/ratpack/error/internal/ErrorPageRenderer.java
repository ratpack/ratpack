...
public abstract class ErrorPageRenderer {
  ...
  public ErrorPageRenderer() {
    if (style == null) {
      ...
      InputStreamReader reader = new InputStreamReader(resourceAsStream, CharsetUtil.getDecoder(CharsetUtil.UTF_8));
      try {
  ...
  protected void render(Context context, String pageTitle, Consumer<? super BodyWriter> body) {
    ...
    PrintWriter printWriter = new PrintWriter(new OutputStreamWriter(out, CharsetUtil.getEncoder(CharsetUtil.UTF_8)));
