...
public interface LaunchConfig {
  ...
  /**
   * Indicates whether responses should include a 'X-Response-Time' header with the number of milliseconds (to 3 decimal places) it took to process the request.
   * <p>
