 ...
 * options.  For example, to enable the capturing and reporting of metrics to {@link DropwizardMetricsModule.Config#jmx(ratpack.func.Action)}
 ...
 *     sysProps()
 *     require("/metrics", DropwizardMetricsModule.Config)
 *   }
 *
 *   bindings {
 ...
 */
public class DropwizardMetricsModule extends ConfigurableModule<DropwizardMetricsModule.Config> {
