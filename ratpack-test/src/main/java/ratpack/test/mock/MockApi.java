 ...
 * }</pre>
 * <p>
 * This fixture is particularly powerful when combined with
 * Spock's {@code Mock} API by providing a Mock {@link HandlerFactory}
 * to this class. Iteractions to a remote API can then be
 * validated inline to the {@code Specification} by
