...
In addition to the `JsonNode`, the `ratpack-jackson` module also provides a way to convert POJOs into parsable types via [`Jackson.fromJson()`](api/ratpack/jackson/Jackson.html#fromJson-com.google.common.reflect.TypeToken--).
