...
Streaming a response always occurs via the [`Response.sendStream()`](api/ratpack/core/http/Response.html#sendStream%28org.reactivestreams.Publisher%29) method.
...
Ratpack supports streaming data over [websockets](http://en.wikipedia.org/wiki/WebSocket) by way of the [`WebSockets.websocketBroadcast()`](api/ratpack/core/websocket/WebSockets.html#websocketBroadcast%28ratpack.core.handling.Context,org.reactivestreams.Publisher%29) method.
