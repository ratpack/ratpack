...
Files from the base dir can be served, using the [`Chain.files()`](api/ratpack/core/handling/Chain.html#files-ratpack.exec.func.Action-) method.
...
Responses are timestamped and compressed in exactly the same manner as described for the [`Chain.files()`](api/ratpack/core/handling/Chain.html#files-ratpack.exec.func.Action-) method. 
