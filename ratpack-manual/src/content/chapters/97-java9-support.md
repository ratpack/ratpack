...
* `ratpack-groovy` requires Groovy 2.5.2 or higher per issue #1411
* `ratpack-groovy-test` requires Groovy 2.5.2 or higher per issue #1411
...
known to have conflict per issue #1418 and proposed fix pull request #1420
  ```
...
* Guice illegal reflective access in issue google/guice#1133:
  ```
  ...
  ```
* Netty debug messages described in issue #1410: 
  ```
