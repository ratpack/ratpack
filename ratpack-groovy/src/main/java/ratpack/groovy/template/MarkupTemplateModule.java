 ...
 * So {@code groovyMarkupTemplate("my/template/path.gtpl")} maps to {@code templates/my/template/path.gtpl} in the application root directory.
 * <p>
 ...
 *         )
 *       ).test(httpClient -> {
 *         assertEquals("<html><body><p>hello!</p></body>", httpClient.get().getBody().getText());
 *       });
 *     });
 *   }
 * }
