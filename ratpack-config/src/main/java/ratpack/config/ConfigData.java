...
public interface ConfigData {
   ...
   * </ul>
   *
   * @param env the environment provider for configuration purposes
   * @param definition the config data definition
   * @return a config data
   * @throws Exception any thrown by building the config data
   */
  static ConfigData of(Environment env, Action<? super ConfigDataBuilder> definition) throws Exception {
    return definition.with(builder(env)).build();
  }

  static ConfigData of(Action<? super ConfigDataBuilder> definition) throws Exception {
    return of(Environment.defaultEnvironment(), definition);
  }
   ...
   * @throws Exception any thrown by building the config data
   */
  static ConfigData of(Environment env, ObjectMapper objectMapper, Action<? super ConfigDataBuilder> definition) throws Exception {
    return definition.with(builder(env, objectMapper)).build();
  }
  ...
  static ConfigDataBuilder builder() {
    return builder(Environment.defaultEnvironment());
  }

  static ConfigDataBuilder builder(ObjectMapper objectMapper) {
    return builder(Environment.defaultEnvironment(), objectMapper);
  }

  static ConfigDataBuilder builder(Environment env) {
    return new DefaultConfigDataBuilder(env);
  }

  static ConfigDataBuilder builder(Environment env, ObjectMapper objectMapper) {
    return new DefaultConfigDataBuilder(env, objectMapper);
  }
